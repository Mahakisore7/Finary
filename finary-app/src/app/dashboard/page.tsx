...
export default function DashboardPage() {
  ...
  // NEW: Logical Check for Empty State
    ...
    <div className="max-w-7xl mx-auto space-y-10 py-10 px-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        ...
        <div className="flex flex-wrap gap-2 w-full md:w-auto bg-zinc-900/40 p-2 rounded-2xl border border-white/5 backdrop-blur-md justify-center md:justify-start">
          <Button onClick={exportToCSV} variant="ghost" size="sm" className="text-zinc-500 hover:text-white uppercase text-[10px] font-bold tracking-widest px-4">
      ...
      {isFirstTimeUser ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 bg-zinc-950 rounded-[3rem] border-2 border-dashed border-zinc-800 text-center space-y-6">
          ...
          <div>
            <h2 className="text-3xl font-black italic uppercase text-white tracking-tighter">Ready to take off?</h2>
            <p className="text-zinc-500 max-w-sm mx-auto mt-2 font-medium">Scan your first receipt or set a budget to unlock Gemini AI insights.</p>
          </div>
